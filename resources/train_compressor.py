...
if __name__ == '__main__':
    ...
    Rot = load_rotations('../resources/rotations.bin')['rotations'].copy().astype(np.float32)
    Pos = load_positions('../resources/positions.bin')['positions'].copy().astype(np.float32)
